...
# A weekly Mon/Wed/Fri (0,2,4) rule starting Tue 2026-09-01, interval 1,
# fires: Sep 1 (Tue), Sep 2 (Wed), Sep 4 (Fri), then each following week
# on Mon/Wed/Fri: Sep 7, 9, 11, 14, 16, 18, 21, 23, 25, 28, 30, Oct 2...
# The 8-week hand-checked sequence below is built from this anchor.
...
def test_hand_checked_8_week_sequence_weekly_mon_wed_fri() -> None:
    ...
    Week 0 (Sep 1-6):   Wed 2, Fri 4        (Mon 31 Aug is pre-start)
    Week 1 (Sep 7-13):  Mon 7, Wed 9, Fri 11
    Week 2 (Sep 14-20): Mon 14, Wed 16, Fri 18
    Week 3 (Sep 21-27): Mon 21, Wed 23, Fri 25
    Week 4 (Sep 28-Oct 4): Mon 28, Wed 30, Fri 2 (Oct)
    Week 5 (Oct 5-11):  Mon 5, Wed 7, Fri 9
    Week 6 (Oct 12-18): Mon 12, Wed 14, Fri 16
    Week 7 (Oct 19-25): Mon 19, Wed 21, Fri 23
    """
    rule = ScheduleRule(
        rule_type=RuleType.WEEKLY, weekday_set={0, 2, 4},
        start_date="2026-09-01", end_date="2026-10-25",
    )
    expected = [
    ...
    actual = occurrences_between(rule, "2026-09-01", "2026-10-25")
...
def test_hand_checked_8_week_sequence_weekly_interval_2_mondays() -> None:
    ...
    fires in weeks 0, 2, 4, 6 -> Sep 7, Sep 21, Oct 5, Oct 19."""
    rule = ScheduleRule(
        rule_type=RuleType.WEEKLY, weekday_set={0}, interval=2,
...
def test_custom_days_hand_checked_8_week_sequence() -> None:
    ...
    actual = occurrences_between(rule, "2026-09-07", "2026-10-27")
    assert actual == [
        ...
        "2026-10-20", "2026-10-22", "2026-10-25", "2026-10-27",
    ]
