"""Re-export of :mod:`custom_components.nestquest.core.dao_children` for the integration package.

The children/admin DAO lives in
:mod:`custom_components.nestquest.core.dao_children` (extracted in
