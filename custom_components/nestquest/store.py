"""Re-export of :mod:`custom_components.nestquest.core.store` for the integration package.

The path resolver lives in
:mod:`custom_components.nestquest.core.store` (extracted in task
d0b691d8) and is Home-Assistant-free:
:func:`custom_components.nestquest.core.store.async_get_db_path`
...
async def async_get_db_path(hass: HomeAssistant) -> Path:
    ...
    :func:`custom_components.nestquest.core.store.async_get_db_path`,
    which ensures the parent directory exists off the event loop via
